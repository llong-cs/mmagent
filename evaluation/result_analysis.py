...
def parse_args():
    ...
    parser.add_argument('--result', type=str, help='Path to the result directory or file', default="data/annotations/results/5_rounds_threshold_0_5_no_planning_qwen")
