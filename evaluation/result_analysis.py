...
def parse_args():
    ...
    parser.add_argument('--result', type=str, help='Path to the result directory or file', default="data/annotations/results/gpt-4o-2024-11-20/5_rounds_threshold_0.5_top5_no_planning_gemini")
